...
import com.mohiva.silhouette.play.test.{FakeAuthenticator, FakeIdentity}
import com.mohiva.silhouette.services.{AuthenticatorService, IdentityService}
import com.mohiva.silhouette._
import com.mohiva.silhouette.exceptions.{ AccessDeniedException, AuthenticationException }
import com.mohiva.play.silhouette.test.FakeAuthenticator
import org.specs2.matcher.JsonMatchers
import org.specs2.mock.Mockito
import org.specs2.specification.Scope
import _root_.play.api.GlobalSettings
import _root_.play.api.i18n.{ Lang, Messages }
import _root_.play.api.libs.concurrent.Akka
import _root_.play.api.libs.json.Json
import _root_.play.api.mvc.Results._
import _root_.play.api.mvc.{ Action, RequestHeader, Result }
import _root_.play.api.test.{ FakeApplication, FakeRequest, PlaySpecification, WithApplication }
