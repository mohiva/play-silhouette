...
import com.mohiva.silhouette.services.AuthInfoService
import com.mohiva.silhouette.util.{Credentials, PasswordInfo, PasswordHasher}
import com.mohiva.silhouette.{RequestProvider, LoginInfo}
