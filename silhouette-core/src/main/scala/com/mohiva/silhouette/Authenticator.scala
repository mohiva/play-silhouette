...
trait Authenticator {
   ...
   *
   * @param result The result to wrap into the [[silhouette.Authenticator.Discard]] result.
   * @return A [[silhouette.Authenticator.Discard]] result.
   */
   ...
   *
   * @param result The result to wrap into the [[silhouette.Authenticator.Renew]] result.
   * @return A [[silhouette.Authenticator.Renew]] result.
   */
