...
import com.mohiva.play.silhouette.core.providers.oauth1.LinkedInIdentity
import play.api.mvc.RequestHeader
import play.api.i18n.Lang

/**
  * The default LinkedIn identity builder.
  */
object LinkedInIdentityBuilder extends IdentityBuilder[LinkedInIdentity, User] {
   ...
   */
  def apply(from: LinkedInIdentity)(implicit request: RequestHeader, lang: Lang) = new User(
