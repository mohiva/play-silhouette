...
import com.mohiva.play.silhouette.core.providers.oauth2.GitHubIdentity
import play.api.mvc.RequestHeader
import play.api.i18n.Lang

/**
 * The default GutHub identity builder.
 */
object GitHubIdentityBuilder extends IdentityBuilder[GitHubIdentity, User] {
   ...
   */
  def apply(from: GitHubIdentity)(implicit request: RequestHeader, lang: Lang) = new User(
