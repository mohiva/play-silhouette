...
import com.mohiva.play.silhouette.core.providers.oauth2.GoogleIdentity
import play.api.mvc.RequestHeader
import play.api.i18n.Lang

/**
 * The default Google identity builder.
 */
object GoogleIdentityBuilder extends IdentityBuilder[GoogleIdentity, User] {
   ...
   */
  def apply(from: GoogleIdentity)(implicit request: RequestHeader, lang: Lang) = new User(
