...
import com.mohiva.play.silhouette.core.providers.oauth2.InstagramIdentity
import play.api.mvc.RequestHeader
import play.api.i18n.Lang

/**
 * The default Instagram identity builder.
 */
object InstagramIdentityBuilder extends IdentityBuilder[InstagramIdentity, User] {
   ...
   */
  def apply(from: InstagramIdentity)(implicit request: RequestHeader, lang: Lang) = new User(
