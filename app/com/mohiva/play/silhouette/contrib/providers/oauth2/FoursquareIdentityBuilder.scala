...
import com.mohiva.play.silhouette.core.providers.oauth2.FoursquareIdentity
import play.api.mvc.RequestHeader
import play.api.i18n.Lang

/**
 * The default Foursquare identity builder.
 */
object FoursquareIdentityBuilder extends IdentityBuilder[FoursquareIdentity, User] {
   ...
   */
  def apply(from: FoursquareIdentity)(implicit request: RequestHeader, lang: Lang) = new User(
