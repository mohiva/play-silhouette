...
class GitLabProviderSpec extends OAuth2ProviderSpec {
  ...
  trait Context extends OAuth2ProviderSpecContext {
     ...
     * The OAuth2 settings.
     */
    lazy val oAuthSettings = spy(OAuth2Settings(authorizationURL = Some("https://gitlab.com/oauth/authorize"), accessTokenURL = "https://gitlab.com/oauth/token", redirectURL = Some("https://www.mohiva.com"), clientID = "my.client.id", clientSecret = "my.client.secret", scope = Some("api")))
